...
public class CommonTokenApi {
    ...
    @GetMapping("/get")
    @ResponseBody
    public String getJwtToken( @RequestParam(value = "appId") @NotBlank String appId,
                              @RequestParam(value = "secret") @NotBlank String secretMd5,
                              @RequestParam(value = "timeMillis") long timeMillis) {
